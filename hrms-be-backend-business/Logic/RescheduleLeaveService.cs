...
namespace hrms_be_backend_business.Logic
{
 ...
            StringBuilder errorOutput = new StringBuilder();
            ...
            try
            {
                ...
                response.ResponseMessage = " Leave Reschedule Created successfully";
                return response;
 ...
            StringBuilder errorOutput = new StringBuilder();
        ...
        public async Task<BaseResponse> GetRescheduleLeaveRequsetByUserId(long UserId, long CompanyId, RequesterInfo requester)
        {
            BaseResponse response = new BaseResponse();
            ...
            try
            {
                ...
                var LeaveRequest = await _rescheduleLeaveRepository.GetRescheduleLeaveRequestByUserId(UserId, CompanyId);
