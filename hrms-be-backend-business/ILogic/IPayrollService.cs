...
namespace hrms_be_backend_business.ILogic
{
    public interface IPayrollService
    {
        ...
        Task<ExecutedResult<byte[]>> DownloadPayrollRunnedReport(long PayRollRunnedId, string AccessKey, IEnumerable<Claim> claim, string AccessFromIPAddress, string AccessFromPort);
    }
}
