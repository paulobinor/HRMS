namespace hrms_be_backend_business.ILogic
{
    public interface ILearningAndDevelopmentMailService
    {
        ...
        Task SendTrainingInductionApprovalMailToApprover(long ApproverUserId, long TrainingInductionByUserId, string TrainingProvider);
        Task SendTrainingInductionApproveConfirmationMail(long RequesterUserId, long ApprovedByUserId, string TrainingProvider);
        Task SendTrainingInductionDisapproveConfirmationMail(long RequesterUserId, long DiapprovedByUserId);
