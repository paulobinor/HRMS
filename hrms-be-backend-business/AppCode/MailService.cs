...
namespace hrms_be_backend_business.AppCode
{
    public class MailService: IMailService
    {
        ...
        //public async Task SendLeaveNotificationMailToUnitHead(long RequesterUserId, long UnitHeadID, DateTime startDate, DateTime endDate)
        //{
        //    try
        //    {
        //        var userDetails = await _accountRepository.FindUser(RequesterUserId);
        //        var ApprovedByUnitHeadUserDetails = await _accountRepository.FindUser(UnitHeadID);
        //        StringBuilder mailBody = new StringBuilder();
        //        mailBody.Append($"Dear {ApprovedByUnitHeadUserDetails.FirstName} {ApprovedByUnitHeadUserDetails.LastName} {ApprovedByUnitHeadUserDetails.MiddleName} <br/> <br/>");
        //        mailBody.Append($"Kindly Approval Leave Request By {userDetails.FirstName} {userDetails.LastName} {userDetails.MiddleName} <br/> <br/>");
        ...
        //            Body = mailBody.ToString(),
        //            Subject = "Leave Request",
        //            ToEmail = ApprovedByUnitHeadUserDetails.officialMail,
        //        };
        //        SendEmailAsync(mailPayload, null);
