...
//        public async Task<BaseResponse<List<RoleDTO>>> GetAllRoles(int CompanyID)
//        {
...
//        public async Task<BaseResponse<RoleDTO>> GetRolesByID(int CompanyID, int roleID)
//        {
...
//        public async Task<BaseResponse<CreateRoleDTO>> CreateRole(CreateRoleDTO payload, string RemoteIpAddress, string RemotePort)
//        {
//            BaseResponse response = new BaseResponse();
//            try
//            {
...
//        public async Task<BaseResponse<UpdateRoleDTO>> UpdateRole(UpdateRoleDTO payload, string RemoteIpAddress, string RemotePort)
//        {
//            BaseResponse response = new BaseResponse();
//            try
//            {
...
//        public async Task<BaseResponse<DeleteRoleDTO>> DeleteRole(DeleteRoleDTO payload, string RemotePort, string RemoteIpAddress)
//        {
//            try
//            {
//                BaseResponse response = new BaseResponse();
